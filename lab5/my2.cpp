...
public:
  ...
  virtual void PrintWholesaleProfit() {
    cout<<"The Factory doesn't know about the WholeSale!"<<endl;
  }

  virtual void PrintRetailProfit() {
    cout<<"The Factory doesn't know about the Retailer!"<<endl;
  }
...
public:
  ...
  virtual void PrintRetailProfit() {
    cout<<"The WholeSaler doesn't know about the Retailer!"<<endl;
  }
...
int main(int argc, char* argv[]){
  ...
  FP-> PrintWholesaleProfit();
  FP-> PrintRetailProfit();
